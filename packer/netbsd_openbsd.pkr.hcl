...
variable "gce_script" { type = string }
variable "postgres_script" { type = string }
variable "lock_root_command" { type = string }
...
build {
  ...
  post-processors {
    ...
    post-processor "googlecompute-import" {
      gcs_object_name   = "packer-${var.task_name}-${var.image_date}.tar.gz"
      bucket            = "${var.bucket}"
